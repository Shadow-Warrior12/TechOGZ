        ...
        <div className="flex flex-col gap-3 flex-1">
            {tokens.map((token, index) => (
                <motion.div
                    ...
                    className="flex items-center justify-between p-3 bg-[#1A1B1E] rounded-lg border border-[#2A2B2E] hover:border-[#3A3B3E] transition-colors"
                >
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-[#151619] flex items-center justify-center text-xs font-bold text-white border border-[#2A2B2E]">
