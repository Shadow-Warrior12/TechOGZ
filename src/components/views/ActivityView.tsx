...
import { Activity, Zap, ShieldCheck, Filter } from "lucide-react";
...
const MOCK_BLOCKS: BlockData[] = [
    { id: "b1", blockNumber: 19234567, miner: "0xf2P...4a1", txns: 184, timeAgo: "12s ago", reward: "2.05 ETH" },
    { id: "b2", blockNumber: 19234566, miner: "0xa3B...8c2", txns: 156, timeAgo: "24s ago", reward: "2.12 ETH" },
    { id: "b3", blockNumber: 19234565, miner: "0xd1E...7f3", txns: 201, timeAgo: "36s ago", reward: "2.08 ETH" },
    { id: "b4", blockNumber: 19234564, miner: "0xb4C...2d5", txns: 143, timeAgo: "48s ago", reward: "2.15 ETH" },
    { id: "b5", blockNumber: 19234563, miner: "0xe5F...9a6", txns: 178, timeAgo: "60s ago", reward: "2.03 ETH" },
];

const TIME_RANGES = ["1H", "24H", "7D", "30D"];

export const ActivityView = () => {
    const [transactions] = useState<Transaction[]>(generateMockTransactions(15));
